...
> **Внимание**: По моим расчетам разработка бека переписки займет **много** времени, коммитов не будет около недели,
> проблема в том, что  кроме обычного чата нужно реализовать и поиск, и премки, и много всего другого. Спасибо за то что вы со мной!
> Если хотите помочь — форкните репозиторий, сделайте небольшую часть и отправьте пул реквест.
