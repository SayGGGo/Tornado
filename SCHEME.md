...
graph TD
    ...
    C_MSG_SYS -.->|Отправка или Получение| API_MSG[Обмен данными о чатах\nи сообщениях /api/messages]:::db
